...
class TestUint32:
    ...
    def test_uint32_out_of_bounds(self, n: int):
    ...
    def test_uint32_in_bounds(self, n: int):
...
class TestBase64Str:
    ...
    def test_base64str_invalid(self, x: str):
...
class TestAlgorandAddress:
    ...
    def test_algorand_address_invalid(self, x: str):
...
class TestUrlSubtypes:
    ...
    def test_url_is_string(self, subtype: Url, x: str):
    ...
    def test_asa_url_invalid(self, subtype: Url):
    ...
    @pytest.mark.parametrize("subtype", [AsaUrl, Arc3Url, Arc3LocalizedUrl])
    def test_url_encoded_length_out_of_bounds(self, subtype: Url):
    ...
    def test_url_invalid_scheme(self, subtype: Url):
    ...
    @pytest.mark.parametrize("subtype", [Arc3Url, Arc3LocalizedUrl])
    def test_url_invalid_gateway(self, subtype: Url):
    ...
    def test_url_valid(self, subtype: Url, x: str):
    ...
    def test_localized_url_valid(self, x: str):
    ...
    def test_arc3_localized_url_invalid(self, x: str):
...
class TestAsaAssetName:
    ...
    def test_asa_asset_name_encoded_length_out_of_bounds(self, x: str):
    ...
    def test_asa_asset_name_valid(self, x: str):
...
class TestArc3Sri:
    ...
    def test_arc3_sri_invalid_hash_algorithm(self):
    ...
    def test_arc3_sri_missing_hash_algorithm(self):
    ...
    def test_arc3_sri_invalid_hash_digest_encoding(self):
    ...
    def test_arc3_sri_invalid_hash_digest_length(self):
...
class TestMimeType:
    ...
    def test_mime_type_invalid(self, subtype: MimeType | ImageMimeType, x: str):
    ...
    def test_image_mime_type_valid(self, x: str):
...
class TestArc3Color:
    ...
    def test_arc3_color_invalid_length(self, x: str):
    ...
    def test_arc3_color_invalid_characters(self, x: str):
    ...
    def test_arc3_color_valid(self, x: str):
...
class TestLocaleString:
    ...
    def test_locale_invalid_string(self, x: str):
...
class TestArc16Traits:
    ...
    def test_arc16_traits_valid(self):
    ...
    def test_arc16_traits_invalid_non_strict(self, x: dict):
    ...
    def test_arc16_traits_invalid_strict(self, x: dict):
    ...
    def test_arc16_traits_valid_non_strict(self, x: str | int):
...
class TestArc3NonTraitProperties:
    ...
    def test_traits_not_allowed(self):
    ...
    def test_invalid_types(self, x: dict, strict: bool):
    ...
    def test_valid_types_not_strict_coerced(self, x: dict, expected):
        """Test that `Arc3NonTraitProperties` raises a ValidationError when passed a dictionary containing invalid types."""
